...
namespace Gm1KonverterCrossPlatform.Tests.Ucp
{
    public class UcpOffsetModuleTests : IDisposable
    {
        ...
        public void WriteAll_WritesModuleFiles()
        {
            ...
            string options = File.ReadAllText(Path.Combine(module.Folder, "options.yml"));
            ...
            Assert.Contains("| 12 | -5 | 7 | set in the Gm1 Konverter |", File.ReadAllText(Path.Combine(module.Folder, "locale", "description-en.md")));
        }
